...
if __name__ == "__main__":
    ...
    while (1): 
        ...
        elif respuesta == "juego de señas":
            
            print("Elegiste la opción JUEGO DE SEÑAS.")
            texto_a_audio("Elegiste la opción JUEGO DE SEÑAS.")

            print("El juego consiste en que el ususrio haga realice las señas de cada palabra que se muestre en pantalla.")
            texto_a_audio("El primer juego consiste en que el ususrio haga realice las señas de cada palabra que se muestre en pantalla.")
